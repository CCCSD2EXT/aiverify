...
def plugin_test_data(request):
    ...
    file_path = str(test_dir / "user_defined_files/simple_tabular_model.pth")
    expected_model_algorithm =  "torch.nn.modules.container.Sequential" # "torch.nn.Sequential" # "collections.OrderedDict"
...
class PluginTest:
    ...
    def _validate_metadata(self) -> Tuple[int, str]:
        ...
        if (
            ...
            == "pytorchmodel supports detecting pytorch models"
